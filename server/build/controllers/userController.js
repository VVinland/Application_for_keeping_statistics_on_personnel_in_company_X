...
class UserController {
    ...
    async lastStepOfRegisteringEmployee(req, res, next) {
        try {
    ...
    async getNumberHired(req, res, next) {
        try {
    ...
    async getNumberDismissed(req, res, next) {
        try {
            const value = req.params.value;
    ...
    async getSalaryPayments(req, res, next) {
        try {
            const value = req.params.value;
